...
###Survival plot custom function to fit survival data generated by package survival to a ggplot

survival_plot<-function(s, conf.int=T, events=T, shape="|", xlab="Time", 
